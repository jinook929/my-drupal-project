...
// Team config workflow: store exported configuration in a Git-tracked
// directory at the project root (outside the web/ docroot). Setting it here,
// before the settings.ddev.php include, prevents DDEV's default from applying.
